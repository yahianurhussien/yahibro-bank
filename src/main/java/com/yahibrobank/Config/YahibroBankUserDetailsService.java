...
//
//// we don't need this if we use our authentication provider see YahibroBankUsernameAndPwdAuthenticationProvider class
//@Component
//public class YahibroBankUserDetailsService implements UserDetailsService {
//
//    @Autowired
