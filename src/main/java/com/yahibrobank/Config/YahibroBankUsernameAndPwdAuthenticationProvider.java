...
//we use this if we want to have custom authentication provider

@Component
public class YahibroBankUsernameAndPwdAuthenticationProvider implements AuthenticationProvider {
